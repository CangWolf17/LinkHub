<template>
  <transition name="slide-up">
    <div
      ...
      class="fixed bottom-4 right-4 w-[480px] max-h-[420px] bg-gray-900/95 backdrop-blur-sm
             rounded-xl shadow-2xl border border-gray-700 z-50 flex flex-col text-sm"
    >
      <!-- 标题栏 -->
      ...
      <div class="flex-1 overflow-y-auto">
        ...
        >
          ...
          <div class="flex items-center gap-2 mb-1.5">
            ...
            <span v-if="entry.pending" class="text-yellow-400 text-[10px] animate-pulse">pending...</span>
